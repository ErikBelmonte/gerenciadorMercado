 ...
 * @author Erik
 */
public class GerenciadorMarket extends javax.swing.JFrame {

    /**
     * Creates new form Supermercado
     */
    public GerenciadorMarket() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GerenciadorMarket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GerenciadorMarket().setVisible(true);
            }
        });
    }
